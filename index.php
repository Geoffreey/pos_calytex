...
/*
| -----------------------------------------------------
| NOMBRE DEL PRODUCTO: Punto de venta CalyTex POS  con sistema de gestión de existencias
| -----------------------------------------------------
| AUTOR:     web.geoffdeep.pw
| -----------------------------------------------------
| EMAIL:      info@web.geoffdeep.pw
| -----------------------------------------------------
| COPYRIGHT:    RESERVED BY WE.GEOFFDEEP.PW
| -----------------------------------------------------
        ...
        <table class="table table-bordered table-striped">
          <tbody>
            <?php foreach (get_users() as $the_user) : ?>
              <?php if (in_array($the_user['email'], array('admin@web.geoffdeep.pw', 'cashier@web.geoffdeep.pw', 'salesman@web.geoffdeep.pw'))) : ?>
