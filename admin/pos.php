...
<?php include('../_inc/template/pos_skeleton.php'); ?>
	<!-- Inicio del contenedor de contenido de POS -->
		...
		<div class="content-area">
			<div class="row-group">
				<div class="content-row">
					...
					<!-- Fin de sección de todos los productos -->
					...
					<div id="right-panel" class="pos-content" style="<?php echo $user->getPreference('pos_side_panel') == 'left' ? 'float:left' : null; ?>">
						<div class="invoice-area">
							<div class="well well-sm">
								...
								<!-- Fin del Área de Clientes-->

								<!-- Inicio del artículo de factura-->
								<div id="invoice-item">
									<!-- Inicio del título de la lista de productos seleccionados -->
									...
									<!-- Título de la lista de productos seleccionados fin -->

									<!-- Inicio de la sección Lista de productos seleccionados-->
									...
									<!-- Fin de sección Lista de productos seleccionados-->

									<!-- Inicio de la sección Cálculo del producto seleccionado-->
									...
									<!-- Fin de sección Cálculo del producto seleccionado-->
								</div>
								<!-- Fin del artículo de factura-->
								...
								<!-- Fin de sección del botón de acción-->
								
								<div class="clearfix"></div>
							</div>
						</div>
					</div>
					<!-- Fin de sección de factura -->
	...
	<!-- Fin del contenedor de contenido POS -->

	<!-- Controlador de alternancia de barra derecha -->
	<div id="minicart">
    ...
    <!-- Fin desplazamiento de la barra lateral -->
...
<noscript>
    <div class="global-site-notice noscript">
        <div class="notice-inner">
            <p><strong>JavaScript parece estar deshabilitado en su navegador.</strong><br>Debe tener JavaScript habilitado en
                su navegador para utilizar la funcionalidad de #MODERN POS.</p>
        </div>
    </div>
</noscript>
</body>
