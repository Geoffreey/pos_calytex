		...
		if (!get_pcode() || !get_pusername() || get_pcode() == 'error' || get_pusername() == 'error') {
			...
			<body>
				<section id=\"wrapper\">
					...
					<div id=\"content\">
						<p>Your purchase code is not valid. If you have a valid purchase code then <a style=\"color:blue\" href=\"".root_url()."/revalidate.php\">Click here</a> to revalide that or Claim a valid purchage code here: <a href=\"mailto:info@geoffdeep.pw\">info@geoffdeep.pw</a> | +8801737346122</p>
						<p style=\"color:blue;\">&mdash; <a style=\"color:green;\" target=\"_blink\" href=\"http://web.geoffdeep.pw\" title=\"web.geoffdeep.pw\">web.geoffdeep.pw</a></p>
					</div>
				</section>
			</body>
			</html>");
