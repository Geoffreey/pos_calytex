	...
	<div class="panel mb-20" style="border:2px dotted #ddd;">
		<div class="panel-body">
			...
			<h4 class="text-center">
			    <a href="http://docs.web.geoffdeep.pw/pos">Online Documentation Here</a>
			</h4>
		</div>
	</div>
	<div class="row mb-20" style="margin-right:0;">
		<div class="col-sm-4">
			<a class="btn btn-info btn-block" href="mailto:info@geoffdeep.pw">Email Us &rarr;</a>
		</div>
		<div class="col-sm-4">
			<a class="btn btn-warning btn-block" href="http://codecanyon.net/user/itsolution-24/follow" target="_blank">Follow Us &rarr;</a>
		</div>
		<div class="col-sm-4">
			<a class="btn btn-success btn-block" href="http://web.geoffdeep.pw/contact.php" target="_blank">Contact Us &rarr;</a>
		</div>	
	</div>
	<br>
