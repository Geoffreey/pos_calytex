...
if (!function_exists("checkValidationServerConnection")) {
    function checkValidationServerConnection($domain = 'www.web.geoffdeep.pw')  
    {
        if($socket =@ fsockopen($domain, 80, $errno, $errstr, 30)) {
            fclose($socket);
            return true;
...
<div class="container">
        ...
        <div class="col-sm-8 col-sm-offset-2">
            <div class="panel panel-default header" style="">
                <div class="panel-heading text-center">
                    <h2>Actualice CalyTex POS de v2.0 a v3.0</h2>
                    <h1>PASO 
                ...
                <?php if (!isset($request->get['update'])):?>
                    <div class="panel-body">
                        ...
                        <p style="color:#ff023b;">Aunque hemos probado varias veces, pero no podemos darle una garantía del 100% de que después de actualizarse con éxito, el sistema funcionará correctamente. Entonces, antes de proceder a actualizar. Por favor, lea/siga la lista de requisitos previos. Usted es solo la persona responsable mientras el sistema no funcione después de actualizarse correctamente.</p>

                        <div class="text-center">
                        <h4 class="bg-info" style="padding:10px;"><b>NECESITA INTERNET, ASEGÚRESE DE QUE SU CONEXIÓN A INTERNET ESTÉ BIEN</b></h4>
                        <h4 class="bg-info" style="padding:10px;"><b>REALIZAR UNA COPIA DE SEGURIDAD DE LA BASE DE DATOS</b></h4>
                        <h4 class="bg-info" style="padding:10px;"><b>REALICE UNA COPIA DE SEGURIDAD DE TODOS LOS ARCHIVOS</b></h4>
                        </div>

                        <div class="alert alert-warning highlight-text" style="margin-bottom:0!important;">
                            <p>*** Esta acción puede tardar varios minutos. Tenga paciencia mientras procesa esta acción y nunca cierre el navegador. De lo contrario, el sistema no funcionará correctamente. Disfruta de una taza de café mientras esperas... :</p>
                        </div>
                    </div>
                <?php endif;?>
            </div>
    ...
    <div class="row" style="margin-top: 10px;">
        <div class="col-sm-8 col-sm-offset-2">  
                        ...
                        <?php if (!isset($request->get['update'])):
                            ...
                            <div class="form-group">
                                <div class="col-sm-7 col-sm-offset-3 text-left">
                                    <button class="btn btn-success btn-block ajaxcall" data-form="updateForm" data-loading-text="Checking...">Siguiente &rarr;</button>
                                </div>
                            </div>
                        <?php endif;?>
                        ...
                        <?php if (isset($request->get['update']) && $request->get['update'] == 'yes'):
                            ...
                            ?>
                                <label for="database" class="col-sm-3 control-label">
                                    <p>Nombre de la base de datos <small>de v2.0</small> <span class="text-aqua">*</span></p>
                                </label>
                                <div class="col-sm-7">
                            ...
                            ?>
                                <label for="port" class="col-sm-3 control-label">
                                    <p>Puerto (3306) <span class="text-aqua">*</span></p>
                                </label>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                <div class="col-sm-7 col-sm-offset-3 text-left">
                                    ...
                                    <div class="clearfix text-center" style="margin-top:30px;">
                                        <a href="<?php echo root_url();?>/update.php">&larr; Volver</a>
                                    </div>
                                </div>
                            </div>
                        <?php endif;?>
            ...
            <div class="text-center copyright">&copy; <a href="http://web.geoffdeep.pw">web.geoffdeep.pw</a>, Todos los derechos reservados.</div>
        </div>
    </div>
</div>
